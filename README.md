...
공부한 것을 한 줄로 적어두면 다시 볼 날을 계산해 주는 macOS 학습 플래너입니다.
...
복습 자체는 앱 밖에서 합니다. 하던 공부를 마치고 돌아와서 네 단계
(다시, 어려움, 무난함, 쉬움) 가운데 하나를 고르면 다음 날짜가 다시 잡힙니다.
...
제목만 적으면 나머지는 기본값으로 들어갑니다. 목표한 날이나 복습 강도를
따로 정하고 싶을 때만 상세 설정을 펼치면 됩니다.

목표한 날을 정해 두면 그날 목표 기억률에 닿도록 일정을 거꾸로 셉니다.
해야 하는 복습은 늦어도 그 전날까지 끝나고, 하루에 몰리지 않게 날짜를 폅니다.
